...
public class SunLineBar extends View {

    private static final String TAG = SunLineBar.class.getSimpleName();
    /**
     * view宽度
     */
    private int width;
    ...
    public SunLineBar(Context context) {
        this(context, null);
    }

    public SunLineBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public SunLineBar(Context context, AttributeSet attrs, int defStyleAttr) {
